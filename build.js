...
function renderServicesItems(items) {
  return items.map(item => `<div class="bg-white p-6 rounded-xl border border-gray-200 shadow text-center hover:shadow-lg hover:-translate-y-1 hover:border-gold transition-all">
